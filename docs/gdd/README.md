...
| 04 | [AI Harness](04-ai-harness/README.md) | `04-ai-harness/` | Gemma 4 integration, tool suite, context management |
...
| AI | Gemma 4 via Candle (local) | Privacy, offline play, audio input on edge models |
...
| Audio | cpal + Gemma 4 native audio | Minimal dependencies, native audio processing in edge models |
